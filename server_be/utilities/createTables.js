...
class TABLES {
    ...
    constructor(){
        ...
        this.sql = {
            ...
            user_details : 'CREATE TABLE IF NOT EXISTS user_details(userId int auto_increment, fname varchar(50), lname varchar(50), phoneNumber varchar(30), emailAddress varchar(30), userName varchar(30), userType int, addressId int, PRIMARY KEY (userId), unique key unq_user_details_2 (userName,userType), CONSTRAINT user_details_ibfk_1 FOREIGN KEY (addressId) REFERENCES address_details (addressId))',
            ...
            item_category_details : 'CREATE TABLE IF NOT EXISTS item_category_details(categoryId int NOT NULL AUTO_INCREMENT, categoryName varchar(30) DEFAULT NULL,PRIMARY KEY (categoryId), UNIQUE KEY unq_item_category_details_1 (categoryName))',
